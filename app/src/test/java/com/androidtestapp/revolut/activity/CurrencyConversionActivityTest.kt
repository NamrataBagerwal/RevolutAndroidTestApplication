...
import com.androidtestapp.revolut.ui.activity.CurrencyConversionActivity
...
class CurrencyConversionActivityTest : KoinTest {
    companion object {
    ...
    private lateinit var activityScenario: ActivityScenario<CurrencyConversionActivity>
    ...
    @Test
    fun `has visible errorTextView on create when internet connection off`() {
    ...
    fun `test recycler view adapter and its data`() {
        ...
        activityScenario.onActivity { activity ->
            ...
            val adapterCurrencyConverterList =
                (activity.currencyConverterRecyclerView.adapter as? CurrencyConversionAdapter)?.currencyConverterList
            Assert.assertEquals(
